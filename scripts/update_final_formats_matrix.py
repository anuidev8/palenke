...
S1 = {
    ...
    "G9": "FORMATO INFORME ADM_ANGEL_ARRIETA_ABRIL_2026.docx; FORMATO INFORME ADM_ANGEL_ARRIETA_MAYO_2026.docx; docs/final-formats/evidences/01",
    ...
    "G10": "https://dev-palenke-two.vercel.app/; docs/final-formats/evidences/screenshots/01-home-plataforma.png",
    ...
    "F11": "Sistema de usuarios y roles operativo: login, control de sesión, lectura de permisos, solicitudes de acceso y revisión administrativa de solicitudes.",
    "G11": "src/middleware.ts; src/lib/auth/permissions.ts; src/lib/viewer.ts; src/app/login; src/app/admin/solicitudes; src/app/solicitar-acceso; docs/final-formats/evidences/04",
    ...
    "G12": "src/lib/document-access.ts; src/lib/auth/permissions.ts; src/lib/viewer.ts; src/app/gobierno-propio/[instrumento]/page.tsx; docs/final-formats/evidences/05",
    ...
    "G13": "src/app/biblioteca/page.tsx; src/components/palenke/BibliotecaSearchBar.tsx; src/components/palenke/BibliotecaFilterSummary.tsx; https://dev-palenke-two.vercel.app/biblioteca; docs/final-formats/evidences/screenshots/02-biblioteca-buscador.png",
    ...
    "G14": "src/app/mujeres-juventudes-ninez/page.tsx; src/app/mujeres-juventudes-ninez/campanas/[slug]/page.tsx; https://dev-palenke-two.vercel.app/mujeres-juventudes-ninez; docs/final-formats/evidences/screenshots/03-mjn.png",
    ...
    "F15": "Power BI / mirador de datos: implementado (catálogo, SCITA/estadísticas, administración de tableros). Geoportal interno: NO implementado como módulo del MVP; diferido a la siguiente etapa. Evidencia de la página de acceso preparatoria en evidences/screenshots/05-geoportal-acceso.png (no constituye cierre del módulo SIG).",
    "G15": "src/app/estadisticas/page.tsx; src/app/scita/page.tsx; src/components/palenke/ScitaDashboardPanel.tsx; src/components/palenke/ScitaDashboardAdminForm.tsx; src/app/admin/dashboards; https://dev-palenke-two.vercel.app/estadisticas; docs/final-formats/evidences/08; Geoportal (siguiente etapa / no MVP): src/app/geoportal/page.tsx; https://dev-palenke-two.vercel.app/geoportal; docs/final-formats/evidences/screenshots/05-geoportal-acceso.png; docs/final-formats/evidences/14_7",
    "H15": "En proceso",
    "I15": 70,
    ...
    "F16": "Seguridad básica operativa en despliegue: HTTPS/SSL, validación de sesión, middleware de control y restricción de acceso a rutas y recursos internos.",
    "G16": "src/middleware.ts; src/lib/auth/permissions.ts; despliegue en Vercel con HTTPS; docs/final-formats/evidences/09",
    ...
    "G17": "https://github.com/anuidev8/palenke; docs/final-formats/evidences/10/REPOSITORIO_GITHUB.md; src/app/admin; docs/final-formats/evidences/10",
    ...
    "G18": "docs/technical/palenke-mvp-technical-documentation.md; docs/technical/palenke-mvp-technical-documentation.html; docs/technical/palenke-mvp-technical-documentation.pdf; docs/protocolo-sig-bi-postgresql-powerbi-y-palenke.md; docs/final-formats/evidences/11",
    ...
    "G19": "docs/final-formats/evidences/12",
    ...
    "G20": "Informes ABRIL y MAYO 2026; repositorio Git del proyecto; docs/final-formats/evidences/13",
    ...
    "G21": "https://dev-palenke-two.vercel.app/; docs/final-formats/evidences/screenshots/01-home-plataforma.png",
    ...
    "G22": "src/middleware.ts; src/lib/auth/permissions.ts; src/app/admin/solicitudes; docs/final-formats/evidences/14_2",
    ...
    "G23": "src/lib/document-access.ts; src/lib/viewer.ts; src/app/gobierno-propio/[instrumento]/page.tsx; docs/final-formats/evidences/14_3",
    ...
    "G24": "https://dev-palenke-two.vercel.app/biblioteca; docs/final-formats/evidences/screenshots/02-biblioteca-buscador.png",
    ...
    "G25": "https://dev-palenke-two.vercel.app/mujeres-juventudes-ninez; docs/final-formats/evidences/screenshots/03-mjn.png",
    ...
    "G26": "src/app/estadisticas/page.tsx; src/components/palenke/ScitaDashboardPanel.tsx; src/components/palenke/ScitaDashboardAdminForm.tsx; src/app/admin/dashboards; docs/final-formats/evidences/14_6",
    ...
    "G27": "https://dev-palenke-two.vercel.app/geoportal; src/app/geoportal/page.tsx; docs/final-formats/evidences/screenshots/05-geoportal-acceso.png; docs/final-formats/evidences/14_7",
    ...
    "G28": "src/middleware.ts; src/lib/auth/permissions.ts; docs/final-formats/evidences/14_8",
    ...
    "G29": "Repositorio Git del proyecto; docs/final-formats/evidences/14_9",
    ...
    "G30": "docs/technical/palenke-mvp-technical-documentation.md; docs/protocolo-sig-bi-postgresql-powerbi-y-palenke.md; docs/final-formats/evidences/14_10",
    ...
    "G33": "src/app/admin/accs/page.tsx; src/app/admin/accs/[id]/editar/page.tsx; src/app/gobierno-propio/page.tsx; https://dev-palenke-two.vercel.app/gobierno-propio; docs/final-formats/evidences/screenshots/06-gobierno-propio-accs.png",
    ...
    "G34": "src/app/incidencia/page.tsx; src/app/incidencia/[slug]/page.tsx; docs/plan-biblioteca-rutas-litigio.md; https://dev-palenke-two.vercel.app/incidencia; docs/final-formats/evidences/screenshots/07-incidencia.png",
    "I34": 55,
    ...
    "G36": "docs/final-formats/evidences/21",
    "I36": 0,
    ...
    "G38": "docs/final-formats/evidences/23",
    ...
    "G39": "Repositorio Git del proyecto; informes ABRIL y MAYO 2026; docs/final-formats/evidences/24",
    ...
    "G42": "https://dev-palenke-two.vercel.app/gobierno-propio; src/app/admin/accs/page.tsx; docs/final-formats/evidences/screenshots/06-gobierno-propio-accs.png",
    ...
    "G43": "src/app/incidencia/page.tsx; src/app/incidencia/[slug]/page.tsx; docs/final-formats/evidences/screenshots/07-incidencia.png",
    "I43": 55,
    ...
    "G45": "docs/final-formats/evidences/25_6",
    "I45": 0,
    ...
    "G47": "docs/final-formats/evidences/25_8",
}
...
S2 = {
    ...
    "D7": "En proceso",
    "E7": "docs/final-formats/evidences/; docs/final-formats/evidences/screenshots/",
    "F7": "Se creó la estructura base del repositorio de evidencias y el inventario de capturas sugeridas; faltan anexar las capturas reales y demás soportes finales.",
    "D8": "No iniciado",
    "E8": "",
    ...
    "F13": "La base técnica y documental existe, pero la transferencia formal sigue pendiente de acta, entrega validada de accesos administrativos y evidencias de capacitación.",
    "D14": "No iniciado",
    "E14": "",
