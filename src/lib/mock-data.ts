...
const normaVigenteDocuments: DocumentRecord[] = [
  ...
  createNormaDoc({
    ...
    title: "Decreto 2163 de 2012 — Fondo de tierras y comunidades",
    type: "Decreto",
    description:
      "Actualiza la reglamentación de la Comisión Consultiva y define instrumentos institucionales para asuntos territoriales y de comunidades negras.",
    council: "Presidencia de la República",
    year: 2012,
    keywords: ["Decreto 2163", "fondo de tierras", "comunidades negras", "consulta"],
    fileLabel: "Ver en Senado",
    url: senateDecreeUrl(2163, 2012),
    sourceUrl: senateDecreeUrl(2163, 2012),
  }),
  createNormaDoc({
  ...
  createNormaDoc({
    ...
    type: "Decreto",
    description:
      "Reconoce y fortalece la protección de áreas de especial interés ambiental con enfoque étnico, clave para conservación y gestión territorial propia.",
    council: "Presidencia de la República",
    year: 2023,
    keywords: ["Decreto 1384", "áreas protegidas", "carácter étnico", "conservación"],
    fileLabel: "Ver en Senado",
    url: senateDecreeUrl(1384, 2023),
    sourceUrl: senateDecreeUrl(1384, 2023),
  }),
  createNormaDoc({
