...
export default async function IncidenciaDetalleePage({
  params,
  searchParams,
}: {
    ...
    >
      ...
      <section className="px-4 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          {/* Incidencia badge */}
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#1a2a1a] px-4 py-1.5">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.16em] text-white/80">
              Incidencia política y territorial
            </span>
          </div>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            <span className="rounded-full border border-white/20 bg-black/30 px-3 py-1.5 text-xs uppercase tracking-[0.16em] text-white/60">
              Imagen destacada — {articulo.categoria}
            </span>
          </div>
          <p className="mt-2 text-xs text-[#7a756e]">
            Foto: Equipo PCN — {articulo.territorio}
          </p>
        </div>
      </section>
