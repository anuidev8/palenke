import { t as createSourceFile } from "../shared-Bilr6W8M.js";
...
function ai(provider) {
	return { async afterWrite() {
		...
		const installer = new FumadocsComponentInstaller(new HttpRegistryConnector("https://fumadocs.dev/registry"), config, this.dest);
		try {
...
async function addAIChat({ template, appDir }) {
	let filePath;
